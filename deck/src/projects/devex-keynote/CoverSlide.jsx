    ...
    <Slide index={0} className={styles.cover}>
      ...
      <div className="content-frame content-gutter">
        <div className={styles.content}>
          <p className={styles.eyebrow}>DevEx Keynote</p>
          <h1>
            Developer <span className={styles.highlight}>Experience</span>
          </h1>
          <p className={styles.subtitle}>
            Keynote presentation on developer experience strategy,
            tooling &amp; culture — empowering teams to ship faster
            with joy.
          </p>
          ...
          <div className={styles.meta}>
            <div className={styles.metaItem}>
              ...
              <span className={styles.metaValue}>DevEx Keynote</span>
            </div>
