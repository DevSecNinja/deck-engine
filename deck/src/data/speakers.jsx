...
const speakers = [
  { initials: 'ST', name: 'Simona Toader', title: 'Global Black Belt Developer AI, GitHub', topic: 'Agentic Workflows & SDLC Transformation', desc: 'Copilot CLI, agentic workflows, and how AI is fundamentally reshaping the software development lifecycle.', avatarColor: 'blue', bgIndex: 1, org: 'GitHub', orgClass: 'gh', icon: ghIcon, photo: photoSimona },
  ...
  { initials: 'PH', name: 'Pascal van der Heiden', title: 'Sr. Solution Engineer AI Apps, Microsoft', topic: 'Spec Driven Development', desc: 'From requirements to production code — spec-first engineering powered by frameworks like SpecKit and OpenSpec.', avatarColor: 'cyan', bgIndex: 3, org: 'Microsoft', orgClass: 'ms', icon: msIcon, photo: photoPascal },
  ...
  { initials: 'AS', name: 'Anton Sizikov', title: 'Sr. Solution Engineer, GitHub', topic: 'AgentHQ — The Home of Coding Agents', desc: 'Inside AgentHQ: the single pane of glass for every coding agent — manage, orchestrate, and scale.', avatarColor: 'green', bgIndex: 4, org: 'GitHub', orgClass: 'gh', icon: ghIcon, photo: photoAnton },
]
